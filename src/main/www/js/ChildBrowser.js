...
// Show a webpage, will result in a callback to onLocationChange
ChildBrowser.prototype.showHTML = function(html)
{
    cordovaRef.exec("ChildBrowserCommand.showHTML", html);
};

// Show a webpage, will result in a callback to onLocationChange
ChildBrowser.prototype.setHTML = function(html)
{
    cordovaRef.exec("ChildBrowserCommand.setHTML", html);
};
